                ...
                <div class="container" style="justify-content: center;">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav mx-auto " style="align-items: center;">
                            <li class="nav-item">
                                <a class="nav-link active" style="margin: 0; width: 100%;" aria-current="page"
                                    href="./">Home</a>
                            </li>
                            <li class="nav-item">
            ...
            <div class="hero-right">
                ...
                <div class="hero-right-row2" data-aos="fade-left">
                    <p class="">
                        ...
                        comprehensive
                        preventive and therapeutic dental care, educates patients on oral hygiene, and manages patient
                        records with
                        precision.
                    </p>
                </div>
                ...
                <div class="hero-right-row4 carousel slide " id="carouselExampleSlidesOnly">
                    <div class="hero-right-row4-box1 carousel-inner" data-bs-ride="carousel" data-aos="fade-left">
                        ...
                        <div class="carousel-item active">
                            <img src="images/dr-imgs/dr-slider-1.webp" class="slideimg w-100"
                                alt="images/toothbrush.jpg">
                        </div>
                        <div class="carousel-item">
                            <img src="images/dr-imgs/dr-slider-2.webp" class="slideimg w-100"
                                alt="images/toothbrush.jpg">
                        </div>
                        <div class="carousel-item">
                            <img src="images/dr-imgs/dr-slider-3.webp" class="slideimg w-100"
                                alt="images/toothbrush.jpg">
                        </div>
                        <div class="carousel-item">
                            <img src="images/dr-imgs/dr-slider-4.webp" class="slideimg w-100"
                                alt="images/toothbrush.jpg">
                        </div>
                    </div>
        ...
        <div class="service-wrapper">
            <div class="service-boxes">
                <div class="box service-box1">
                    ...
                    <button class="btn-service-section-arrow" onclick="window.location.href='services'"
                        data-aos="fade-right">
            ...
            <div class="row">
                    ...
                    <div class="short-about-left">
                        ...
                        <div class="short-about-left-description">
                            <p style="font-size:larger;">
                                Dr. Anand Rajnikant Shah is a dedicated and highly experienced dental professional with
                                over 13 years of
                                expertise in the field.
                            </p>
                            <p style="font-size:large;">
                                Based in Panvel, he is recognized for his extensive knowledge and hands-on experience in
                                a wide range of
                        ...
                        <div class="short-about-left-buttons row gap-3">
                            <div class="col-md-4">
                                <button class="btn-contact-about" onclick="window.location.href='contactus'">Contact
                                    Us</button>
                            </div>
                        </div>
                        <div class="short-about-left-footer">
                            ...
                            <button onclick="window.location.href='about'"
                                ...
                                <img src="icons/black-slant-arrow.svg" width="24px" height="24px" alt="" />
                            </button>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="short-about-right">
                        <div class="boxes">
                            <div class="img-box">
                                <img src="images/dr-imgs/dr1-with-book.webp" width="80%" height="80%"
                                    alt="Short About" />
                            </div>
                            <div class="box box1">
